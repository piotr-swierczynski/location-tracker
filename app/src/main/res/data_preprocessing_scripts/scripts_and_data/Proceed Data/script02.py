...
if not load_from_json:
	path = "Gathering Data Michi Approach/"+file
	...
	mac_dict = ds.File.load_info_from_json_file("Gathering Data Michi Approach/"+file)
"""
...
for key, signals in mac_dict.iteritems():
	...
	for s in signals:
		if cut_from_the_beginning > 0:
			...
			continue
		signal_without_beginning.append(int(s))
...
minimum_number_of_signals_to_consider_access_point = 40
min_avg_to_consider = -85
...
def get_the_most_significant_mac_addresses(avg_dict, number_to_get):
	...
	while number_to_get > 0:
		last_signal_avg = min_avg_to_consider
		mac_address = ""
...
final_data_dict = {}
for key, signals in mac_dict.iteritems():
	if (key == '5c:96:9d:65:76:8d' or
		key == '80:ea:96:eb:1e:fc' or
		key == '1c:aa:07:b0:74:c2' or
		key == '1c:aa:07:7b:39:11' or
		key == '20:c9:d0:18:43:f3' or
		key == 'e0:3f:49:09:d9:98' or
		key == '1c:aa:07:b0:74:c0' or
		key == '1c:aa:07:b0:7a:b0' or
		key == '1c:aa:07:b0:7a:b1' or
		key == '1c:aa:07:b0:7a:b2'):
		if signals == []:
			continue
...
outputPath = "Gathering Data Michi Approach/StdResult_"+file
fout = open(outputPath, 'w')
fout.write(string_to_be_put_into_file)
fout.close()

outputPath = "Gathering Data Michi Approach/FtStdResult_"+file
fout = open(outputPath, 'w')
